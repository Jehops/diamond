...
struct Statistics
{
	...
	enum value {
		...
		TIME_SEARCH, SEEDS_HIT, RESEEKED_DIAGONALS, ADJACENCY_FILTERED_SEED_HITS, UNGAPPED_EXTENSION_FILTERED_SEED_HITS, TIME_KMER_NEIGHBORS, TIME_KEYWORD_TREE, COUNT
	};
